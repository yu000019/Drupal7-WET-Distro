...
function genesis_clf_nice_menus_build($variables) {
  $menu = $variables['menu'];
  $depth = $variables['depth'];
...
function genesis_clf_nice_menus_main_menu($variables) {
  $direction = $variables['direction'];
  $depth = $variables['depth'];
...
function genesis_clf_nice_menus_menu_item_link($variables) {

              ...
              <div id="cn-sig">
                <div id="cn-sig-inner">
                  <?php if ($language->language == 'en'): ?>
                    <div id="fip-pcim-sig-eng" title="Public Organization"><img src="/<?php print(drupal_get_path('theme', 'genesis_public'));?>/wetcss/wet-boew-theme-gcwu-fegc-v1.0b5/theme-gcwu-fegc/fip-pcim/images/sig-eng.gif" width="214" height="20" alt="Public Organization"></div>
                  <?php endif;?>
                  <?php if ($language->language == 'fr'): ?>
                    <div id="fip-pcim-sig-fra" title="organisation publique"><img src="/<?php print(drupal_get_path('theme', 'genesis_public'));?>/wetcss/wet-boew-theme-gcwu-fegc-v1.0b5/theme-gcwu-fegc/fip-pcim/images/sig-fra.gif" width="214" height="20" alt="organisation publique"></div>
                  <?php endif;?>
                </div>
              </div>
        ...
        <div id="cn-banner-inner">
          <div id="cn-wmms">
            <div id="cn-wmms-inner">
              <?php if ($language->language == 'en'): ?>
                <div id="fip-pcim-wmms" title="Symbol of the Public Organization"><img src="/<?php print(drupal_get_path('theme', 'genesis_public'));?>/wetcss/wet-boew-theme-gcwu-fegc-v1.0b5/theme-gcwu-fegc/fip-pcim/images/wmms.gif" width="126" height="30" alt="Symbol of the Public Organization"></div>
              <?php endif;?>

              <?php if ($language->language == 'fr'): ?>
                <div id="fip-pcim-wmms" title="Symbole du organisation publique"><img src="/<?php print(drupal_get_path('theme', 'genesis_public'));?>/wetcss/wet-boew-theme-gcwu-fegc-v1.0b5/theme-gcwu-fegc/fip-pcim/images/wmms.gif" width="126" height="30" alt="Symbole du organisation publique"></div>
              <?php endif;?>
            </div>
          </div>
  ...
  <div id="cn-cols-inner" class="equalize">
      <div id="cn-centre-col" role="main" itemprop="mainContentOfPage">
        <div id="cn-centre-col-inner">
            ...
            <h1 id="cn-cont" class="cn-invisible"><?php print t('Public Organization - Drupal CLF3'); ?></h1>
            <div id="cn-content">
...
<div id="cn-foot"><div id="cn-foot-inner">
    ...
    <nav role="navigation">
            ...
            <?php print $menu_gov_terms_bar; ?>
					...
					<div class="clear"></div>
					<section>
						<div class="span-2"><?php print $menu_gov_about_bar; ?></div>
					</section>
					<section>
						<div class="span-2"><?php print $menu_gov_news_bar; ?></div>
					</section>
					<section>
						<div class="span-2"><?php print $menu_gov_contact_bar; ?></div>
					</section>
					<section>
						<div class="span-2"><?php print $menu_gov_connected_bar; ?></div>
					</section>

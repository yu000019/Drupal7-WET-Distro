 ...
 *    search/replace on "genesis_clf_intranet".
...
function genesis_clf_intranet_preprocess(&$vars, $hook) {
}
function genesis_clf_intranet_process(&$vars, $hook) {
}
// */
...
function genesis_clf_intranet_process_html(&$vars) {
}
// */
...
function genesis_clf_intranet_process_page(&$vars) {
}
// */
...
function genesis_clf_intranet_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function genesis_clf_intranet_preprocess_comment(&$vars) {
}
function genesis_clf_intranet_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function genesis_clf_intranet_preprocess_block(&$vars) {
}
function genesis_clf_intranet_process_block(&$vars) {
}
// */
function genesis_clf_intranet_preprocess_html(&$vars) {  
...
function genesis_clf_intranet_preprocess_page(&$vars) { 
  ...
  $menu = i18n_menu_navigation_links('menu-goc-nav-bar');
  ...
  $menu = i18n_menu_navigation_links('menu-goc-footer-bar');
  ...
  //About Us Section
  $menu = i18n_menu_navigation_links('menu-goc-about-us-bar');
  ...
  //News Bar
  $menu = i18n_menu_navigation_links('menu-goc-news-bar');
  ...
  //Contact Us Bar
  $menu = i18n_menu_navigation_links('menu-goc-contact-bar');
  ...
  //Stay Connected Bar
  $menu = i18n_menu_navigation_links('menu-goc-connected-bar');
  ...
  //Terms Bar
  $menu = i18n_menu_navigation_links('menu-goc-terms-bar');
...
function genesis_clf_intranet_links__menu_goc_terms_bar($variables)  {
...
function genesis_clf_intranet_links__menu_goc_sections($variables)  {
  $links = $variables['links'];
  $attributes = $variables['attributes'];
  $heading = $variables['heading'];
  global $language_url;
...
function genesis_clf_intranet_links__menu_goc_footer_bar($variables) {
  $links = $variables['links'];
  $attributes = $variables['attributes'];
  $heading = $variables['heading'];
  global $language_url;
...
function genesis_clf_intranet_links__menu_goc_nav_bar($variables) {
  $links = $variables['links'];
  $attributes = $variables['attributes'];
  $heading = $variables['heading'];
  global $language_url;

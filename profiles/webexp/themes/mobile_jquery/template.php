...
function mobile_jquery_form_alter(&$form, &$form_state, $form_id) {
  if ($form_id == 'search_block_form') {
    $form['search_block_form']['#title'] = t('Search'); // Change the text on the label element
    $form['search_block_form']['#title_display'] = 'invisible'; // Toggle label visibilty
    $form['search_block_form']['#size'] = 25;  // define size of the textfield
    $form['actions']['submit']['#value'] = t('GO!'); // Change the text on the submit button
    $form['search_block_form']['#attributes']['placeholder'] = t('Search OpenConcept.ca');
    // print_r($form);
  }   
}
...
function mobile_jquery_page_alter(&$page) {

 ...
 * This is provided for structural organizational purposes and its usage is not required.
 *
 * @see hook_permission()
 */
 ...
 * @param $standard (optional)
 *   A machine name string of the standard to use.
 *   When defined, only the standard that matches this string will loaded into the standards array.
 *   When undefined, all standards will be loaded into the standards array.
 * @param $other_arguments (optional)
 ...
 *     This is used to load the guideline class whose class object must be defined as follows:
...
*     This is used to load the reporter class whose class object must be defined as follows:
 ...
 *   The target, in general, represents the scope in which the standards will be applied.
 *   The following targets are directly supported: 'snippet', 'page'.
 * - function_history: (optional) An array of function names, ie: array('0' => 'my_function_name').
 *
 ...
 *   A number representing the display level.
 *   When defined, the return value to only contain the display level that matches this string.
 *   When undefined, all display levels will be loaded into the display_levels array.
 * @param $other_arguments (optional)
 *   Array of additional arguments.
 *
 ...
 * @param validation_method (optional)
 *   A machine name representing of the validation method.
 *   When defined, the return value to only contain the validation method that matches the given id.
 *   When undefined, all validation methods will be loaded into the validation_method array.
 * @param $other_arguments (optional)
 *   Array of additional arguments.
 *
